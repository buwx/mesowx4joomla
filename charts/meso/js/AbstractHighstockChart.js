...
meso.AbstractHighstockChart = (function() {
    ...
    var DEFAULT_OPTIONS = {
        ...
        groupDateTimeLabelFormats: {
           ...
           week: ['Woche von %A, %e. %b, %Y', '%A, %e. %b', '-%A, %e. %b, %Y'],
           month: ['%B %Y', '%B', '-%B %Y'],
           year: ['%Y', '%Y', '-%Y']
        },
    ...
    AbstractHighstockChart.prototype._buildChartOptions = function() {
        ...
        chartOptions.xAxis = jQuery.extend(true, xAxisOptions, this.options.xAxis.highstockAxisOptions);
        // y-axes & series
        chartOptions.yAxis = [];
        chartOptions.series = [];
        ...
        this.options.yAxes.forEach(function(axisDef, axisIndex) {
            ...
            var axis = jQuery.extend(true, {}, axisDef.highstockAxisOptions);
            if( !axis.labels ) {
                axis.labels = {
    ...
    */
    ...
    AbstractHighstockChart.prototype._buildSeriesChartOptions = function(seriesDef, axisDef) {
        ...
        var seriesOptions = jQuery.extend(true, seriesDefaultOptions, seriesDef.highstockSeriesOptions);
