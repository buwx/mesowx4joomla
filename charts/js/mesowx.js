...
mesowx.Unit = (function() {
    ...
    var Unit = {
        ...
        inHr : new meso.UnitDef("inHr", 'in/h'), // inches per hour
        mmHr : new meso.UnitDef("mmHr", 'mm/h'), // millimeters per hour
        cmHr : new meso.UnitDef("cmHr", 'cm/h'), // centimeters per hour

        mph : new meso.UnitDef("mph", 'mph'), // miles per hour
        kph : new meso.UnitDef("kph", 'km/h'), // killometers per hour
